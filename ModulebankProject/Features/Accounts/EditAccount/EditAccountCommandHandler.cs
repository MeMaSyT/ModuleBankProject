...
public class EditAccountCommandHandler : IRequestHandler<EditAccountCommand, MbResult<AccountDto, ApiError>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return !editingAccount.IsSuccess ? MbResult<AccountDto, ApiError>.Failure(editingAccount.Error!) : MbResult<AccountDto, ApiError>.Success(_mapper.Map<AccountDto>(editingAccount.Result));
    }
}