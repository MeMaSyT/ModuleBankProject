...
public class TransactionsController : Controller
{
    ...
    /// <returns></returns>
    // ReSharper disable once RouteTemplates.ActionRoutePrefixCanBeExtractedToControllerRoute хочет нарушить структуру
    ...
    /// <returns></returns>
    // ReSharper disable once RouteTemplates.ActionRoutePrefixCanBeExtractedToControllerRoute хочет нарушить структуру
    [HttpGet("{ownerId:guid}/{id:guid}", Name = "GetTransaction")]
